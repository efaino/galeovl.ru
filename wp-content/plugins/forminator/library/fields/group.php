...
class Forminator_Group extends Forminator_Field {
	...
	private static function render_action_buttons( $options ) {
		...
		if ( 'icon' === $options['action_element_type'] ) {
			// Icons.
			$html .= '<button class="forminator-repeater-action-icon forminator-repeater-add"><span class="forminator-icon-add" aria-hidden="true"></span><span class="sui-screen-reader-text">'. esc_attr( $options['add_text'] ) .'</span></button>';
			$html .= '<button class="forminator-repeater-action-icon forminator-repeater-remove"><span class="forminator-icon-remove" aria-hidden="true"></span><span class="sui-screen-reader-text">' . esc_attr( $options['remove_text'] ) . '</span></button>';
