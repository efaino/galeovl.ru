...
} else if ( 'imgcarousel' == $headoption ) {
	get_template_part( 'templates/imagecarousel', 'slider' );
} else if ( 'carousel' == $headoption || 'carouselslider' == $headoption ) {
