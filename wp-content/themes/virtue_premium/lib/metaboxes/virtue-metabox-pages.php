...
function virtue_metabox_pages() {
	...
	// Default Page.
	$virtue_default_page = new_cmb2_box(
		array(
			'id'                => 'default_page_sidebar',
			'title'             => __( 'Page Options', 'virtue' ),
			'object_types'      => array( 'page' ),
			'exclude_templates' => array( 'page-landing.php', 'page-sidebar.php', 'page-feature-sidebar.php', 'page-blog.php', 'page-blog-grid.php', 'page-contact.php', 'page-fullwidth.php', 'page-feature.php', 'page-portfolio.php', 'page-portfolio-category.php' ),
			'show_on_cb'        => 'virtue_cmb_exclude_templates',
			'priority'          => 'low',
			'context'           => 'side',
		)
	);
	$virtue_default_page->add_field(
		array(
	...
	// Page templates.
	$virtue_template_pages = new_cmb2_box(
		array(
	...
	$virtue_template_pages->add_field(
		array(
			'name'    => __( 'Page Content Width', 'virtue' ),
			'desc'    => '',
			'id'      => $prefix . 'page_content_width',
...
function virtue_contact_page_metaboxes() {
	...
	$kt_contact_page = new_cmb2_box(
		array(
			...
			'show_on' => array(
				'key' => 'page-template',
				'value' => array( 'page-contact.php' ),
			),
			'priority'   => 'high',
		)
	);
	$kt_contact_page->add_field(
		array(
...
function virtue_staff_template_metaboxes() {
	...
	$kt_staff_page = new_cmb2_box(
		array(
			...
			'show_on' => array(
				'key' => 'page-template',
				'value' => array( 'page-staff-grid.php' ),
			),
			'priority'   => 'high',
		)
	);
	$kt_staff_page->add_field(
		array(
...
function virtue_testimonial_template_metaboxes() {
	$prefix = '_kad_';
	$kt_testimonial_page = new_cmb2_box(
		array(
			...
			'show_on' => array(
				'key' => 'page-template',
				'value' => array( 'page-testimonial-grid.php' ),
			),
			'priority'   => 'high',
		)
	);
	$kt_testimonial_page->add_field(
		array(
			'name'    => __( 'Columns', 'virtue' ),
			'desc'    => '',
...
function virtue_blog_page_metaboxes() {
	...
	$kt_blog_page = new_cmb2_box(
		array(
			...
			'show_on' => array(
				'key' => 'page-template',
				'value' => array( 'page-blog.php' ),
			),
			'priority'   => 'high',
		)
	);
	$kt_blog_page->add_field(
		array(
...
function virtue_bloggrid_page_metaboxes() {
	...
	$kt_bloggrid_page = new_cmb2_box(
		array(
			...
			'show_on' => array(
				'key' => 'page-template',
				'value' => array( 'page-blog-grid.php' ),
			),
			'priority'   => 'high',
		)
	);
	$kt_bloggrid_page->add_field(
		array(
			'name' => __( 'Blog Category', 'virtue' ),
			'desc' => __( 'Select all blog posts or a specific category to show', 'virtue' ),
			'id' => $prefix . 'blog_cat',
