...
.author-profile .author-occupation, .nav-tabs>li.active>a, .nav-tabs>li.active>a:hover, .nav-tabs>li.active>a:focus, .product_price, .product_details > .product_excerpt {color:' . $virtue_premium['font_p']['color'] . ';}';
	...
	if ( ! empty( $virtue_premium['primarymenu_hover_color'] ) ) {
		$color_pmenu_hover = '#nav-main ul.sf-menu a:hover, #nav-main ul.sf-menu a:focus, .nav-main ul.sf-menu a:hover, .nav-main ul.sf-menu a:focus, #nav-main ul.sf-menu li.current-menu-item > a, .nav-main ul.sf-menu li.current-menu-item > a, #nav-main ul.sf-menu ul li a:hover, .nav-main ul.sf-menu ul li a:hover, #nav-main ul.sf-menu ul li a:focus, .nav-main ul.sf-menu ul li a:focus {color:' . $virtue_premium['primarymenu_hover_color'] . ';}';
	} else {
		$color_pmenu_hover = '';
	}
	if ( ! empty( $virtue_premium['primarymenu_hover_bg_color'] ) ) {
		$color_pmenu_bg_hover = '#nav-main ul.sf-menu li a:hover, #nav-main ul.sf-menu li a:focus, .nav-main ul.sf-menu a:hover, .nav-main ul.sf-menu a:focus, #nav-main ul.sf-menu li.current-menu-item > a, .nav-main ul.sf-menu li.current-menu-item > a, #nav-main ul.sf-menu ul li a:hover, .nav-main ul.sf-menu ul li a:hover, #nav-main ul.sf-menu ul li a:focus, .nav-main ul.sf-menu ul li a:focus  {background:' . $virtue_premium['primarymenu_hover_bg_color'] . ';}';
	} else {
		$color_pmenu_bg_hover = '';
	}
	if ( ! empty( $virtue_premium['secondarymenu_hover_color'] ) ) {
		$color_smenu_hover = '#nav-second ul.sf-menu > li:hover > a, #nav-second ul.sf-menu a:hover, #nav-second ul.sf-menu a:focus, #nav-second ul.sf-menu li.current-menu-item > a, #nav-second ul.sf-menu ul li a:hover {color:' . $virtue_premium['secondarymenu_hover_color'] . ';}';
	} else {
		$color_smenu_hover = '';
	}
	if ( ! empty( $virtue_premium['secondarymenu_hover_bg_color'] ) ) {
		$color_smenu_bg_hover = '#nav-second ul.sf-menu > li:hover, #nav-second ul.sf-menu > li:focus, #nav-second ul.sf-menu > li.current-menu-item, #nav-second ul.sf-menu ul > li.current-menu-item, #nav-second ul.sf-menu ul li a:hover, #nav-second ul.sf-menu ul li a:focus {background:' . $virtue_premium['secondarymenu_hover_bg_color'] . ';}';
	} else {
		$color_smenu_bg_hover = '';
	}
	if ( ! empty( $virtue_premium['mobilemenu_hover_color'] ) ) {
		$color_mmenu_hover = '.kad-mobile-nav .kad-nav-inner li.current-menu-item>a, .kad-mobile-nav .kad-nav-inner li a:hover, .kad-mobile-nav .kad-nav-inner li a:focus, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:hover .kad-menu-name, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:focus .kad-menu-name, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:hover .kad-navbtn, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:focus .kad-navbtn, .nav-trigger-case:hover .kad-navbtn {color:' . $virtue_premium['mobilemenu_hover_color'] . ';}';
	} else {
		$color_mmenu_hover = '';
	}
	if ( ! empty( $virtue_premium['mobilemenu_hover_bg_color'] ) ) {
		$color_mmenu_bg_hover = '.kad-mobile-nav .kad-nav-inner li.current-menu-item>a, .kad-mobile-nav .kad-nav-inner li a:hover, .kad-mobile-nav .kad-nav-inner li a:focus, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:hover .kad-menu-name, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:focus .kad-menu-name, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:hover .kad-navbtn, #kad-banner .mobile-nav-trigger-id a.nav-trigger-case:focus .kad-navbtn {background:' . $virtue_premium['mobilemenu_hover_bg_color'] . ';}';
	} else {
...
.login .form-row .button, .post-password-form input[type="submit"], .menu-cart-btn .kt-cart-total, #kad-head-cart-popup a.button.checkout, .kad-post-navigation .kad-previous-link a:hover, .kad-post-navigation .kad-next-link a:hover, .shipping-calculator-form .button, .cart_totals .checkout-button, .select2-results .select2-highlighted, .variations .kad_radio_variations label.selectedValue, #payment #place_order, .shop_table .actions input[type=submit].checkout-button, input[type="submit"].button, .productnav a:hover, .image_menu_hover_class, .select2-container--default .select2-results__option--highlighted[aria-selected], .has-virtue-primary-background-color {background: ' . $virtue_premium['primary_color'] . ';}';
	} else {
		$color_primary = '';
	}
	if ( ! empty( $virtue_premium['primary20_color'] ) ) {
		$color_primary30 = 'a:hover, .has-virtue-primary-light-color {color: ' . $virtue_premium['primary20_color'] . ';} .kad-btn-primary:hover, .button.pay:hover, .login .form-row .button:hover, #payment #place_order:hover, .yith-wcan .yith-wcan-reset-navigation:hover, .widget_shopping_cart_content .checkout:hover,.single_add_to_cart_button:hover,
...
.widget_layered_nav ul li.chosen a:hover, .shop_table .actions input[type=submit].checkout-button:hover, #kad-head-cart-popup a.button.checkout:hover, input[type="submit"].button:hover, .product_item.hidetheaction:hover .kad_add_to_cart, .post-password-form input[type="submit"]:hover, .has-virtue-primary-light-background-color {background: ' . $virtue_premium['primary20_color'] . ';}';
	...
	if ( ! empty( $virtue_premium['x2_virtue_logo_upload']['url'] ) ) {
		$x2logo = ' @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) { body #kad-banner #logo .kad-standard-logo, body #kad-banner #logo .kt-intrinsic-container-center {display: none;} body #kad-banner #logo .kad-retina-logo {display: block;}}';
	} else {
		$x2logo = '';
	}
	...
	if ( isset( $virtue_premium['show_mobile_btn'] ) && $virtue_premium['show_mobile_btn'] == 1 ) {
		$mobilebtn = ' header .nav-trigger .nav-trigger-case {width: auto;} .nav-trigger-case .kad-menu-name {display:none;} @media (max-width: 767px) {header .nav-trigger .nav-trigger-case {width: auto; top: 0; position: absolute;} .id-kad-mobile-nav {margin-top:50px;}}';
	} else {
		$mobilebtn = '';
	}
	...
	if ( isset( $virtue_premium['header_style'] ) && 'shrink' == $virtue_premium['header_style'] ) {
		...
		$menu_line_height = '.kad-header-style-three #nav-main ul.sf-menu > li > a {line-height:' . esc_attr( $header_height ) . 'px; height:' . esc_attr( $header_height ) . 'px;}';
		...
		$menu_line_height = '.kad-center-head-shrink .nav-main ul.sf-menu > li > a {line-height:' . esc_attr( $header_height ) . 'px; height:' . esc_attr( $header_height ) . 'px;}';
	} else {
		$menu_line_height = '';
	}
	if ( isset( $virtue_premium['paragraph_margin_bottom'] ) ) {
		$paragraph_spacing = '.entry-content p { margin-bottom:' . esc_attr( $virtue_premium['paragraph_margin_bottom'] ) . 'px;}';
	} else {
		$paragraph_spacing = '';
	}
