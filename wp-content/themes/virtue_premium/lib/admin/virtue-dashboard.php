				...
				<div class="kt-promo-box-contain kt-promo-three">
					<div class="kt-tutorials-promo kt-promo-box">
						...
						<div class="kt-content-promo">
							...
							<a href="https://www.kadencewp.com/support-forums/forum/virtue-theme/" target="_blank"><?php echo esc_html__( 'Ask a question', 'virtue' ); ?></a>
						</div>
					</div>
				</div>
				<div class="kt-promo-box-contain kt-promo-three">
					<div class="kt-tutorials-promo kt-promo-box">
						...
						<div class="kt-content-promo">
							...
							<a href="https://www.kadencewp.com/kadence-tutorials/?utm_source=virtue-welcome&utm_medium=dashboard&utm_campaign=virtue-premium" target="_blank"><?php echo esc_html__( 'View', 'virtue' ); ?></a>
						</div>
					</div>
				</div>
			</div>
			<div class="kt-promo-row">
				...
				<div class="kt-promo-box-contain kt-promo-three">
					<div class="kt-newsletter-promo kt-promo-box">
						...
						<div class="kt-content-promo">
							<h3><?php echo esc_html__( 'Transferring from Free to Premium', 'virtue' ); ?></h3>
				...
				<div class="kt-promo-box-contain kt-promo-full">
					<div class="kt-newsletter-promo kt-promo-box">
						...
						<div class="kt-content-promo">
							...
							<a href="https://www.kadencewp.com/newsletter-subscribe/?utm_source=virtue-welcome&utm_medium=dashboard&utm_campaign=virtue-premium" target="_blank"><?php echo esc_html__( 'Subscribe', 'virtue' ); ?></a>
						</div>
					</div>
				</div>
			</div>
...
function virtue_bundled_plugins() {
	...
	$suggested      = array(
		...
		'kadence-blocks-pro'  => array(
			...
			'plugin_check' => 'kadence-blocks-pro/kadence-blocks-pro.php',
			'name'         => 'Kadence Blocks Pro',
			'active_url'   => admin_url( 'options-general.php?page=kadence_blocks' ),
			'action_title' => __( 'Blocks Settings', 'virtue' ),
			'desc'         => 'Kadence Blocks Pro extends the Kadence Blocks plugin with added premium blocks.',
			'author'       => 'Kadence Themes',
			'image'        => get_template_directory_uri() . '/assets/img/kbp_logo.jpg',
			'redirect_url' => '',
		),
...
function virtue_suggested_plugins() {
	$suggested         = array(
		'kadence-blocks'   => array(
			'slug'         => 'kadence-blocks',
			'base'         => 'kadence-blocks',
			'category'     => __( 'Gutenberg', 'virtue' ),
			'plugin_check' => 'kadence-blocks/kadence-blocks.php',
			'active_url'   =>  admin_url( 'options-general.php?page=kadence_blocks' ),
			'action_title' => __( 'Blocks Settings', 'virtue' ),
			'name'         => 'Kadence Blocks',
			'desc'         => 'This plugin adds custom blocks to extend Gutenberg’s editing capabilities to better build custom layouts and make Gutenberg able to do more closely what popular page builders can do.',
			'image'        => esc_url( get_template_directory_uri() . '/assets/img/ktb_logo.jpg' ),
			'author'       => 'Kadence Themes',
			'redirect_url' => '',
		),
		'wordpress-seo' => array(
...
function virtue_kadence_blocks_notice() {
	if ( get_option( 'virtue_premium_blocks_plugin_notice' ) || get_transient( 'virtue_premium_blocks_plugin_notice' ) || ! current_user_can( 'manage_options' ) || ! function_exists( 'register_block_type' ) ) {
		return;
	}
	$installed_plugins = get_plugins();
	...
	<div id="message" class="updated kt-plugin-install-notice-wrapper">
		<h3 class="kt-notice-title"><?php echo esc_html__( 'Thanks for choosing the Virtue Premium Theme', 'virtue' ); ?></h3>
		<p class="kt-notice-description"><?php /* translators: %s: <strong> <a> */ printf( esc_html__( 'We have a %1$snew plugin%2$s to extend and enhance Gutenberg for your site. To take full advantage of the Virtue Premium Theme please install the %3$sKadence Blocks%4$s, this adds extra Gutenberg settings and features.', 'virtue' ), '<a href="https://wordpress.org/plugins/kadence-blocks/" target="_blank">', '</a>', '<strong>', '</strong>' ); ?></p>
		<p class="submit">
	...
	<?php
	wp_enqueue_style( 'kadence-blocks-install' );
...
function virtue_hide_blocks_plugin_notice() {
	if ( isset( $_GET['virtue-kadence-blocks-plugin-notice'] ) && isset( $_GET['_notice_nonce'] ) ) {
		...
		update_option( 'virtue_premium_blocks_plugin_notice', true );
	}
}
