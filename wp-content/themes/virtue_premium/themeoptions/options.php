...
/**
    ...
    $args = array(
        ...
        'default_show'         => false,
        'default_mark'         => '',
        'footer_credit' => __('Thank you for using the Virtue Theme by <a href="https://kadencewp.com/" target="_blank">Kadence WP</a>.', 'virtue'),
        'hints'                => array(
...
Redux::setSection( $opt_name, array(
    ...
    'desc' => "<div class='redux-info-field'><h3>".__('Welcome to Virtue Theme Options', 'virtue')."</h3>
        ...
        <br />
        ".__('For support please visit', 'virtue').": <a href=\"https://kadencewp.com/support/\" target=\"_blank\">kadencewp.com/support/</a></p></div>",
    ...
    'fields' => array(
        ...
        array(
            ...
            'description' => __( 'Upload a one retina image here and set your max width to half the retina image size and you do not need to set a retina image below.', 'virtue' ),
        ),
		array(
			'id' =>'logo_width',
			'type' => 'text', 
			'customizer' => true,
			'validate' => 'numeric',
			'title' => __( 'Logo max width', 'virtue' ),
			'subtitle' => __( 'Set with a number only', 'virtue' ),
		),
        array(
...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(
		array(
			...
			'subtitle' => __( 'If you do not want an image slider on your home page choose none.', 'virtue' ),
			'options'  => array(
				'none'        => __( 'None', 'virtue' ),
				'flex'        => __( 'Slider Equal Ratio Images', 'virtue' ),
				'thumbs'      => __( 'Thumb Slider', 'virtue' ),
				'fullwidth'   => __( 'Fullwidth Slider', 'virtue' ),
				'carousel'    => __( 'Slider Different Ratio Images', 'virtue' ),
				'imgcarousel' => __( 'Images in Carousel', 'virtue' ),
				'rev'         => __( 'Revolution Slider', 'virtue' ),
				'cyclone'     => __( 'Shortcode Entry', 'virtue' ),
				'ksp'         => __( 'Kadence Slider Pro', 'virtue' ),
				'ktslider'    => __( 'Kadence Slider Standard', 'virtue' ),
				'latest'      => __( 'Latest Posts', 'virtue' ),
...
Redux::setSection(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'id'      =>'default_page_sidebar_id',
				'type'    => 'select',
				'title'   => __( 'Choose a Default Sidebar for your Single Pages', 'virtue' ),
				'data'    => 'sidebars',
				'default' => 'sidebar-primary',
				'width'   => 'width:60%',
			),
...
Redux::setSection(
	...
	array(
		...
		'icon_class' => 'icon-large',
		'customizer' => false,
		'title'      => __( 'Custom Post Type Options', 'virtue' ),
		'desc'       => '<div class="redux-info-field"><p>' . __( 'This applies to post types that may be added by 3rd party plugins or through a child theme.' ) . '</p></div>',
		'fields'     => array(
			array(
				'id'      => 'custom_post_sidebar_default',
				'type'    => 'select',
				'title'   => __( 'Custom Post Type Sidebar Default', 'virtue' ),
				'options' => array(
					'yes' => __( 'Yes, Show', 'virtue' ),
					'no'  => __( 'No, Do not Show', 'virtue' ),
				),
				'width'   => 'width:60%',
				'default' => 'yes',
			),
			array(
				...
				'type'    => 'select',
				'title'   => __( 'Choose a default sidebar for your Custom Post Types', 'virtue' ),
				'data'    => 'sidebars',
				'default' => 'sidebar-primary',
				'width'   => 'width:60%',
			),
			array(
				...
				'type'     => 'switch',
				'title'    => __( 'Show featured image with custom post type?', 'virtue' ),
				'subtitle' => __( 'Choose to show or hide featured image above post title.', 'virtue' ),
				'default'  => 0,
			),
			array(
				'id'       => 'custom_post_show_author',
				'type'     => 'switch',
				'title'    => __( 'Show Author icon with custom post type?', 'virtue' ),
				'subtitle' => __( 'Choose to show or hide author icon under post title.', 'virtue' ),
				'default'  => 0,
			),
			array(
				'id'       => 'custom_post_show_comment',
				'type'     => 'switch',
				'title'    => __( 'Show comment icon with posts?', 'virtue' ),
				'subtitle' => __( 'Choose to show or hide comment icon under post title.', 'virtue' ),
				'defaul'   => 0,
...
Redux::setSection( $opt_name, array(
    ...
    array(
            ...
            'customizer' => true,
            'transparent'=>false,
            'output' => array('#nav-main ul.sf-menu ul li a:hover, #nav-main ul.sf-menu ul li a:focus, #nav-second ul.sf-menu ul li a:hover, #nav-second ul.sf-menu ul li a:focus, .nav-main ul.sf-menu ul li a:hover, .nav-main ul.sf-menu ul li a:focus'),
            'validate' => 'color',
            ),
    array(
...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			...
			'subtitle' => __( 'This is depreciated, use appearance > customizer > site identity', 'virtue' ),
        ),
        array(
            'id'=>'contact_email',
            'type' => 'text',
        ...
        array(
         ...
         array(
            ...
            'type' => 'image_select',
            'title' => __('Display the sidebar on Search Results Page?', 'virtue'), 
            'subtitle' => __('This determines if there is a sidebar on the search results.', 'virtue'),
            'options' => array(
					'full' => array('alt' => 'Full Layout', 'img' => OPTIONS_PATH .'img/1col.png'),
					'sidebar' => array('alt' => 'Sidebar Layout', 'img' => OPTIONS_PATH .'img/2cr.png'),
                ),
        ...
        array(
         ...
         array(
            'id'=>'search_results_show_search',
            'type' => 'select',
            'title' => __('Add Search field at top of search results page', 'virtue'), 
            'options' => array('false' => __('False', 'virtue'),'true' => __('True', 'virtue') ),
            'width' => 'width:60%',
            'default' => 'false',
        ),
        array(
        ...
        array(
			...
			'subtitle' => __('Please Note, while this can be considered a "cool" feature it is not always the best feature for your users. We suggest caution and testing if you are going to enable.', 'virtue'),
			'options' => array( '0' => __( 'Leave Off', 'virtue' ), '2' => __( 'Use - no replacement of scroll bar', 'virtue' ), '1' => __( 'Use - with scroll bar replacement (depreciated)', 'virtue' ) ),
			'width' => 'width:60%',
			'default' => '0',
		),
		array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
            ...
            array(
                ...
                'type' => 'switch', 
                'title' => __( 'Enable Install for Cyclone Slider Pro - No longer recomended that you use this plugin.', 'virtue' ),
