                            ...
                            if ( isset ( $field['validate'] ) ) {
                                ...
                                if ( ! class_exists( $validate ) ) {
                                    ...
                                    if(!isset($this->args['opt_name'])){
                                    	...
                                    	$opt = $this->args['opt_name'];
                                    }
                                    $class_file = apply_filters( "redux/validate/{$opt}/class/{$field['validate']}", self::$_dir . "inc/validation/{$field['validate']}/validation_{$field['validate']}.php", $class_file );
