...
if (true == $mobile_slider && true == $mobile_detect) {
    if ((isset($virtue_premium['above_header_slider']) && $virtue_premium['above_header_slider'] == 1) && isset($virtue_premium['choose_slider']) && ($virtue_premium['choose_slider'] == 'ktslider' || $virtue_premium['choose_slider'] == 'cyclone' || $virtue_premium['choose_slider'] == 'rev' || $virtue_premium['choose_slider'] == 'ksp')) {
        ...
        if ($slider == "rev") {
            ...
            get_template_part('templates/mobile_home/mobileshortcode', 'slider');
        }
    }
} else {
...
$company = get_field('aboutCompany');
?>
...
<div id="content" class="container homepagecontent <?php echo esc_attr(virtue_container_class()); ?>">
    ...
    <div class="home-content">
        <div class="home-content_slider">
            <div class="promotion__items">
                <?php foreach ($slider

                               as $slides) :
                    $title = $slides['title'];
                    $description = $slides['title'];
                    $new = $slides['newOrNot'];
                    $img = $slides['img']['url'];
                    $url = $slides['url'];
                    ?>
                    <div class="promotion__item">
                        <div class="promotion__item__text">
                            <div class="promotion__item__title">
                                <h2><?= $title ?></h2>
                                <?php if (!empty($new)): ?>
                                    <div class="promotion__item__new">
                                        <p><?= $new; ?></p>
                            ...
                            <p><?= $description ?></p>
                            <div class="promotion__item__link">
                                <a href="<?= $url ?>">Подробнее</a>
                            </div>
                        </div>
                        <div class="promotion__item__img">
                            <img src="<?= $img ?>" alt="">
                        </div>
                        <div class="promotion__items__background"></div>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
        <div class="home-content_about-us">
            <div class="home-content_about-us__title"><h2>Наши преимущества</h2></div>
            <div class="home-content_about-us__items">
                <div class="about-us-item">
                    <img src="/wp-content/uploads/ico-equipment.png" alt="">
                    <span>
                    Современное оборудование
                </span>
                </div>
                <div class="about-us-item">
                    <img src="/wp-content/uploads/ico-methods.png" alt="">
                    <span>
                    Разнообразные методики
                </span>
                </div>
                <div class="about-us-item">
                    <img src="/wp-content/uploads/ico-healing.png" alt="">
                    <span>
                    Широкий выбор лечебных линий
                </span>
                </div>
                <div class="about-us-item">
                    <img src="/wp-content/uploads/ico-weloveyou.png" alt="">
                    <span>
                    Особое отношение к каждому
                </span>
                </div>
            </div>
        ...
        <div class="our-services">
            <div class="our-services__title"><h2>Наши услуги</h2></div>
                ...
                <?php foreach ($uslugi
                    ...
                    <div class="our-services__item">
                        <?php if (!empty($link)): ?><a href="<?= $link ?>"> <?php endif; ?>
                            <div class="our-services__item__img"><img src="<?= $img ?>" alt="">
                                <!--<div class="our-services__item__img__background">
                                    <div class="our-services__item__img__background__btn">
                                        <a href="#zapis" class="zapisats">Записаться</a>
                                    </div>
                                </div>-->
                            </div>
                            <div class="our-services__item_title"><h2><?= $title ?></h2></div>
        ...
        <div class="about-company">
            <div class="about-company__title"><h2>О компании</h2></div>
            <div class="about-company__items">
                <?php foreach ($company as $item) :
                    ...
                    <div class="about-company__item">
                        <div class="about-company__item__text">
    ...
    <!--    <div class="row">-->
    <!--        <div class="main --><?php //echo esc_attr(virtue_main_class());
    ?><!--" role="main">-->
    ...
    //                                    }
    ?>
    <!--                                    <div id="homelatestposts"-->
    <!--                                         class="homecontent --><?php //echo esc_attr($fullclass);
    ?><!--  -->
    <?php //echo esc_attr($postclass);
    ?><!-- clearfix home-margin"-->
    <!--                                         data-fade-in="--><?php //echo esc_attr($animate);
    ?><!--">-->
    <!--                                        --><?php //if ($summery == 'full') {
    ?>
    <!--                                            <div class="kt_home_archivecontent -->
    <?php //echo esc_attr($scrollclass);
    ?><!--" --><?php //echo wp_kses_post($infinit);
    ?><!-->
    ...
    <!--                                                     class="rowtight kt_home_archivecontent -->
    <?php //echo esc_attr($scrollclass);
    ?><!-- init-isotope"-->
    <!--                                                     data-iso-match-height="-->
    <?php //echo esc_attr($matchheight);
    ?><!--" --><?php //echo $infinit;
    ?>
    <!--                                                     data-fade-in="-->
    <?php //echo esc_attr($animate);
    ?><!--"-->
    <!--                                                     data-iso-selector=".b_item" data-iso-style="masonry">-->
    <!--                                                    --><?php //while (have_posts()) : the_post();
    ?>
    <!--                                                        --><?php //if ($blog_grid_column == 'twocolumn') {
    ?>
    <!--                                                            <div class="-->
    <?php //echo esc_attr($itemsize);
